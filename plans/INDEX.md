...
| [playground/PLAN_LINEAGE_DESIGN_MODE.md](playground/PLAN_LINEAGE_DESIGN_MODE.md) | Show connector entities not yet assigned to any channel in an unmapped pool row at the bottom of the lineage diagram; omitted when all entities are mapped | proposed | XS |
