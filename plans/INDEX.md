...
| [playground/PLAN_LINEAGE_FIELD_PREVIEW.md](playground/PLAN_LINEAGE_FIELD_PREVIEW.md) | Expandable field preview on pool pills (unassigned entities) and unmapped-field section in expanded channel entity groups — helps users discover available fields during mapping | backlog | S |
