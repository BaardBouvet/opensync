/**
 * OpenSync POC v5 — SQLite database layer
 *
 * Extends v4 with two new tables:
 *   request_journal  — every HTTP call made via ctx.http (auth masked)
 *   webhook_queue    — raw inbound webhook payloads pending processing
 */
