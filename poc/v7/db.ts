/**
 * OpenSync POC v7 — SQLite database layer
 *
 * Extends v6 with two new tables:
 *   channel_onboarding_status  — explicit per-channel "ready" flag
 *   onboarding_log             — append-only history of discover/onboard runs
 */
